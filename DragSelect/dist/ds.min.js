(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?module.exports=f():typeof define==='function'&&define.amd?define(f):(g=typeof globalThis!=='undefined'?globalThis:g||self,g.DragSelect=f());})(this,(function(){'use strict';const addModificationObservers = (nodes, cb) => {
    const callback = cb;
...
const num2vect = (n) => ({ x: n, y: n });const handleKeyboardDragPosDifference = ({ shiftKey, keyboardDragSpeed, zoom, key, dragKeys, scrollDiff, }) => {
...
DragSelect.isCollision = isCollision;return DragSelect;}));